function [deconvolvedImData, enhancedPSF] = twoStepDeconvolution_Slice(imData,PSF,numberIterations,normalizationFactor)
...
deconvolvedImData=deconvolvedImData./max(normalizationFactor(:));
